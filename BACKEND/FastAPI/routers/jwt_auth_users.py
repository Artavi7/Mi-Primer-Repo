...
users_db = {
    "artavi":{
        "username": "artavi",
        "full_name": "Ariel Tapia Videla",
        "email": "tapia.ariel1992@gmail.com",
        "disabled": False,
        "password": "$2a$12$6uDhC1GSbqLq1XWMxX0aV.ZuiOXdxNe8a7fPq.EpLSwUKatF/jP56"
    },
    "mouredev": {
        "username": "mouredev",
    ...
    "mouredev2": {
        ...
        "disabled": True,
        "password": "$2a$12$8TI3o3Jt9bBjnthxGJSWXOzL1XYXyq3iOFW7S0e3mGJZ0IwLXWbjq"
    }
}
